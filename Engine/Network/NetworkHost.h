...
public:
    NetworkHost(HostType type, uint32_t max_peers = 32, uint8_t max_channels = 2);
    NetworkHost(HostType type, const NetworkAddress &network_address, uint32_t max_peers = 32, uint8_t max_channels = 2);

    NetworkHost(HostType type, std::unique_ptr<ISocket> socket, uint32_t max_peers = 32, uint8_t max_channels = 2);
    NetworkHost(HostType type, std::unique_ptr<ISocket> socket, const NetworkAddress &network_address, uint32_t max_peers = 32, uint8_t max_channels = 2);
    ~NetworkHost() = default;
